    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tourapp.Comment')),
            ],
        ),
        migrations.CreateModel(
            name='Restaurant',
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tourapp.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('restaurant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tourapp.Restaurant')),
            ],
        ),
        migrations.AddField(
            model_name='comment',
            name='review',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tourapp.Review'),
        ),
    ]
